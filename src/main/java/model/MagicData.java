package model;// Code generated by Wire protocol buffer compiler, do not edit.
...
public final class MagicData extends Message<MagicData, MagicData.Builder> {
  ...
  @WireField(
      tag = 1,
      adapter = "model.MagicData$Marker#ADAPTER",
  ...
  @WireField(
      tag = 2,
      adapter = "model.MagicData$Information#ADAPTER",
      label = WireField.Label.REQUIRED
  )
  ...
  public String toString() {
    ...
    return builder.replace(0, 2, "model.MagicData{").append('}').toString();
  }
  ...
  public static final class Information extends Message<Information, Information.Builder> {
    ...
    @WireField(
        tag = 3,
        adapter = "model.MagicData$Images#ADAPTER",
